...
base_path = f'{script_dir}/../../../data/oasis/near/ATLAS'

tar_path = f'{script_dir}/ATLAS_R2.0.tar.gz'

ignored_cohorts = ['R027', 'R047', 'R049', 'R050']

if os.path.exists(tar_path):
    tar_output = f'{script_dir}/tmp/ATLAS'
    ...
    for cohort in tqdm(os.listdir(training_path), desc='Processing ATLAS data', unit='cohort'):
        ...
        for subject in tqdm(subjects, desc=f'Processing {cohort}', leave=False, unit='subject'):
